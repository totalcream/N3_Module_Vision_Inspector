...
IMPLEMENT_DYNAMIC(CPYH_Comm, CCmdTarget)
...
bool CPYH_Comm::OpenPort(CString portname)
{
...
bool CPYH_Comm::ConfigurePort(DWORD BaudRate, BYTE ByteSize, DWORD fParity,
...
bool CPYH_Comm::SetCommunicationTimeouts(DWORD ReadIntervalTimeout,
...
bool CPYH_Comm::WriteByte(char bybyte)
{
	//iBytesWritten=0;
	m_iBytesWritten = 0;
	cout << bybyte << endl;
...
bool CPYH_Comm::ReadByte(BYTE &resp)
{
	BYTE rx;
	resp = 0;
...
bool CPYH_Comm::ReadByte(BYTE* &resp, UINT size)
{
	DWORD dwBytesTransferred = 0;
